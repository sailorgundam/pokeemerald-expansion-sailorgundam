...
static const struct MenuAction MultichoiceList_PokeHelperChoice[] =
{
    {gText_PokeHelperDefog},
    {gText_PokeHelperFlash},
    {gText_PokeHelperFly},
};
...
static const struct MultichoiceListStruct sMultichoiceLists[] =
{
    ...
    [MULTI_POKEHELPER_CHOICE]          = MULTICHOICE(MultichoiceList_PokeHelperChoice),
};
